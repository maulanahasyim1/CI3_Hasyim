...
<div class="container">
   ...
   <form action="<?php echo base_url('index.php/guru/action_edit/'.$data['id'])?>" method="post">
    <div class="mb-3">
        <label for="" class="form-label">NAMA</label>
        <input class="form-control" type="text" name="name" value="<?php echo $data['name'] ?>" required><br>
    </div>
    <div class="mb-3">
    ...
    <div class="d-grid gap-2">
    <button class="btn btn-danger">Data Siswa</button>
    </div>
    </a>
</div>
</div>
